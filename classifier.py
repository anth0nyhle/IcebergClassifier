...
if __name__ == "__main__":
    ...
    csv_logger = callbacks.CSVLogger("test7_9lay_epoch_results.log", separator=",", append=False)
    ...
    np.savetxt("test7_9lay_default_predlabels.csv", labels_test, delimiter=",")
    np.savetxt("test7_9lay_default_dev_acc.csv", cvscores, delimiter=",")

    with open("test7_submission.csv", "w") as submission_file:
